              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="space-y-6">
                  <div>
                    <label
                      className={`${
                        errorEmail ? "text-red-600" : "text-slate-900"
                      } text-[15px] font-medium mb-2 block`}
                    >
                      Email
                    </label>
                  ...
                  <div>
                    <label
                      className={`${
                        errorPassword ? "text-red-600" : "text-slate-900"
                      } text-[15px] font-medium mb-2 block`}
                    >
                      Password
                    </label>
                    <div className="relative flex items-center">
                      ...
                      {showpass ? (
                        <FaRegEye
                          className="w-4.5 h-4.5 absolute right-4 cursor-pointer text-[#bbbbbb]"
