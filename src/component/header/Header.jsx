...
function Header() {
  ...
  return (
    <header className="flex shadow-md py-4  bg-white min-h-17.5 tracking-wide relative z-50">
      ...
      {mobileMenu ? (
        <div className="absolute z-999 w-full top-17 translate-x-0 duration-300 block lg:hidden">
        ...
        <div className="absolute z-999 w-full top-17 translate-x-1150 duration-300 block lg:hidden">
          <ul className="bg-white w-full ">
            <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
              <a
                href="javascript:void(0)"
